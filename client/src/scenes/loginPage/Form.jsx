...
const registerSchema = yup.object().shape({
  ...
  location: yup.string().required("erforderlich"),
  occupation: yup.string().required("erforderlich"),
  picture: yup.string().required("erforderlich"),
});
      ...
      {({
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Box>
            ...
            >
              {isLogin
                ? "Sie haben kein Konto? Hier anmelden."
